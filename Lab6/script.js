...
const tr1 = new Triangle(17, 21, 'tr1');
const tr2 = new Triangle(12, 15, 'tr2');
const tr3 = new Triangle(3, 8, 'tr3');
...
const trz1 = new Trapezoid(7, 5, 6, "trz1");
const trz2 = new Trapezoid(2, 3, 4, "trz2");
const trz3 = new Trapezoid(9, 6, 4, "trz3");
...
const myCar = new Car("Audi", "Avant", 2012, "White", 200);
...
management.addEmployee("Jan", "Kowalski", 5000);
management.addEmployee("Max", "Smith", 6000);
management.addEmployee("", "Johnson", 4500);

const jsonData = management.saveToJSON();
console.log(jsonData);

management.removeEmployee("Jan", "Michael");
